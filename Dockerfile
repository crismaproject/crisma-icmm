...
# docker run -d -p 48014:80 [-v /datadir:/icmmdata] --env ICMM_ENDPOINT=http://localhost:48014/icmm_api --link c_orion:orion peterkutschera/crisma-icmm
# e.g.
# docker run --name c_icmm -d -p 48014:80 -v $(pwd)/data/icmm:/icmmdata --env ICMM_ENDPOINT=http://localhost:48014/icmm_api --link c_orion:orion peterkutschera/crisma-icmm
